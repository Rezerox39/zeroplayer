...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            library::commands::get_genres,
            library::commands::like_track,
            library::commands::unlike_track,
            library::commands::is_liked,
            library::commands::get_liked_ids,
            library::commands::get_liked_tracks,
            library::commands::block_track,
            library::commands::unblock_track,
            library::commands::get_blocklist,
            library::commands::update_track_meta,
            library::commands::get_recently_played,
            library::commands::get_top_played,
            library::commands::export_playlist,
            library::commands::get_folders,
            library::commands::get_playlists,
            library::commands::create_playlist,
            library::commands::delete_playlist,
            library::commands::add_to_playlist,
            library::commands::remove_from_playlist,
            library::commands::get_playlist_tracks,
            library::commands::import_spotify_playlist,
            library::commands::import_youtube_playlist,
            library::commands::download_track,
